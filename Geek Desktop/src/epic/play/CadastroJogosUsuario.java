 ...
 * @author Andy54053236
 */
public class CadastroJogosUsuario extends javax.swing.JInternalFrame {

    /**
     * Creates new form CadastroJogosUsuario
     */
    String id_jogos_usuario;
    public CadastroJogosUsuario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Jogos Usuário", "Id Usuários", "Id Jogos"
            }
        ));
    ...
    private void btCadastroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btCadastroMouseClicked
        try {
            ...
            String sql = "INSERT INTO jogos_usuario(id_usuario,id_jogos)VALUES(?,?);";
        ...
        try {
            Connection con = Conexao.conexaoBanco();
            String sql = "SELECT * FROM jogos_usuario ORDER BY id_jogos_usuarios";
            PreparedStatement stmt = con.prepareStatement(sql);
            ResultSet rs = stmt.executeQuery();
            DefaultTableModel tabelaModelo = (DefaultTableModel) tabela.getModel();
            tabelaModelo.setNumRows(0);
            while(rs.next()){
                Object [] dados = {rs.getString("id_jogos_usuarios"),rs.getString("id_usuario"),rs.getString("id_jogos")};
    ...
    private void btExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExcluirMouseClicked
        try {
            Connection con = Conexao.conexaoBanco();
            String sql = "DELETE FROM jogos_usuario WHERE id_jogos_usuarios = ?";
            PreparedStatement stmt = con.prepareStatement(sql);
            stmt.setString(1, id_jogos_usuario);
            stmt.execute();
            stmt.close();
            con.close();
    ...
    private void btAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAlterarMouseClicked
        try {
            Connection con = Conexao.conexaoBanco();
            String sql = "UPDATE jogos_usuario SET id_jogos_usuarios = ?,id_usuario = ?,id_jogos = ?";
            PreparedStatement stmt = con.prepareStatement(sql);
            stmt.setString(1, idUsuario.getText());
            stmt.setString(2, idJogo.getText());
            stmt.executeUpdate();
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        id_jogos_usuario = (tabela.getValueAt(tabela.getSelectedRow(), 0).toString());
