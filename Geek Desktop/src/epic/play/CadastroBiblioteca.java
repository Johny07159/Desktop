 ...
 * @author Andy54053236
 */
public class CadastroBiblioteca extends javax.swing.JInternalFrame {

    /**
     * Creates new form CadastroBiblioteca
     */
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Biblioteca", "Id Usuários", "Id Jogos"
            }
        ));
    ...
    private void btExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExcluirMouseClicked
        try {
            ...
            stmt.setString(1, id_biblioteca);
            stmt.execute();
            stmt.close();
            con.close();
        ...
        try {
            Connection con = Conexao.conexaoBanco();
            String sql = "SELECT * FROM biblioteca ORDER BY id_biblioteca";
            PreparedStatement stmt = con.prepareStatement(sql);
            ResultSet rs = stmt.executeQuery();
            DefaultTableModel tabelaModelo = (DefaultTableModel) tabela.getModel();
            tabelaModelo.setNumRows(0);
            while(rs.next()){
                Object [] dados = {rs.getString("id_biblioteca"),rs.getString("id_usuario"),rs.getString("id_jogos")};
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        id_biblioteca = (tabela.getValueAt(tabela.getSelectedRow(), 0).toString());
    ...
    private void btCadastroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btCadastroMouseClicked
        try {
            Connection con = Conexao.conexaoBanco();
            String sql = "INSERT INTO biblioteca(id_usuario,id_jogos)VALUES(?,?);";
            PreparedStatement stmt = con.prepareStatement(sql);
    ...
    private void btAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAlterarMouseClicked
        try {
            Connection con = Conexao.conexaoBanco();
            String sql = "UPDATE biblioteca SET id_biblioteca = ?,id_usuario = ?,id_jogos = ?";
            PreparedStatement stmt = con.prepareStatement(sql);
            stmt.setString(1, idUsuario.getText());
            stmt.setString(2, idJogo.getText());
            stmt.executeUpdate();
