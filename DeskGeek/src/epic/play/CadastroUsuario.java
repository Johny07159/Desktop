...
public class CadastroUsuario extends javax.swing.JInternalFrame {
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
        ...
        try {
            ...
            if(ex.getMessage().equals("Duplicate entry 'jon@gmaoil.com' for key 'usuario.email'")){
                       JOptionPane.showMessageDialog(null,"Erro: Nome ou E-mail Ja esta em uso.");
                  }      
            Logger.getLogger(CadastroUsuario.class.getName()).log(Level.SEVERE, null, ex);
 ...
 try {
            ...
            con.close();
            if(linhasAfetadas > 0){
             JOptionPane.showMessageDialog(null,"Usuáro alterado");
             nome.setText(null);
             email.setText(null);   
             senha.setText(null);   
                
            }else{
                JOptionPane.showMessageDialog(null, " Nenhuim usuario foi alterado. Verifique o ID.");
            }
...
DebugLoggerSwing.log("Erro de Depulicidade :"+ ex.getMessage());      
                        
JOptionPane.showMessageDialog(null , "Erro no banco de dados:" + ex.getMessage());
DebugLoggerSwing.log("Erro SQL:" + ex.getMessage());
}
 
 try {
 
     DebugLoggerSwing.log("Atualizando Lista de Usuarios");
     Connection con = Conexao.conexaoBanco();
     String sql = "SELECT * FROM usuario ORDER BY id_usuario";
     PreparedStatement stmt = con.prepareStatement(sql);
     ResultSet rs = stmt.executeQuery();
     ...
     while (rs.next()){
      ...
      con.close();
             ...
             Logger.getLogger(CadastroUsuario.class.getName()).log(Level.SEVERE,null,ex);
             DebugLoggerSwing.log("Erro ao atualizar a Lista:"+ ex.getMessage());
             }
